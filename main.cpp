...
int main(int argc, char *argv[])
{
    ...
    // from ball and field.
    WorldMap *worldMap = new WorldMap(false); //CHANGE THIS SETTING TO ADAPT TO EACH SIDE OF FIELD
    ...
    Coach* coach = new Coach(_players, worldMap, false); //BLUE: true, YELLOW: FALSE; CHANGE THIS SETTING TO ADAPT TO EACH SIDE OF FIELD
